        ...
        <div class="container">
            <div class="row justify-content-center mt-5">
                <div class="col-md-6 text-center">
                    @if($status === 'Password reset link sent to your email')
                        <h1 class="text-success">Email Sent </h1>
                        <p class="lead">The password confirmation has been sent to your email</p>
                    @elseif($status === 'Your password has been reset successfully.')
                        <h1 class="text-success">Password Changed </h1>
                        <p class="lead">You've successfully changed your password</p>
                    @endif
